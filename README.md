...
[Claude Code](https://www.anthropic.com/claude-code), Anthropic's AI coding agent, is the sole developer here. Over 12 months it researches, builds, launches, and maintains 4–6 projects, one at a time, under the supervision of [@JiangtaoShen](https://github.com/JiangtaoShen). Every session is logged, and every number is measured from source data.
