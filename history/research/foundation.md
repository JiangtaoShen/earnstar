...
2. **Winning is rare, and rarer without an audience.** Of repos with ≥ 10 stars, 13.7 % reach 100 and 1.7 % reach 1,000. For owners with < 100 followers (counted today) the rates are about 10 % and 0.6 %; for everyone else about 22 % and 4.4 %. The gap is an upper bound, because a hit moves its owner out of the small bucket; if half the winners whose owners now have 100–999 followers started below 100, it shrinks to about 0.9 % vs 3.7 % (§4, §9, L-005).
3. **Archetype shifts the odds several-fold.** By normalized lift (share among winners vs among repos with 10–99 stars), agent skills are over-represented about 2.2× and AI tooling 1.2×, while non-AI developer tools (0.4×) and playful projects (0.35×) are under-represented. Rough conversion to 1,000 stars: skills about 3–8 %, non-AI tools about 1 %, playful projects under 1 %; these rest on 6 sampled days and a keyword proxy (§4, §9, L-006). Within one problem space, the skill form beats the tool form (anti-slop linters < 40 stars; the humanizer skill 52k).
...
5. **Set expectations by base rates.** For owners with < 100 followers, about 10 % of repos with ≥ 10 stars reach 100 and roughly 0.6–0.9 % reach 1,000 (L-005, §9). Predictions in the selection ADR must start from these numbers.
...
|---|---|---|---|
| 1 | Followers are counted after the stars arrived, so the gap between small-audience and other owners (0.57 % vs 4.4 %) is inflated: hits move their owners into the "other" bucket. If half of the 129 winners with 100–999 followers had < 100 at launch, the gap is about 0.9 % vs 3.7 %. | high | Accepted. §2, §4, §8, and L-005 now call the gap an upper bound and give this bracket. To do: estimate followers at launch. |
| 2 | The lower tiers come from 6 days, 5 of them Sundays and 2 before the skills boom; the skill share of the 10–99 tier ranges from 0.3 % to 8.7 % by day, so P(≥ 1,000 given skill) spans roughly 3–8 %. | high | Accepted. The estimates are reported as rough ranges, not to two decimals. To do: 20+ days stratified by month and weekday. |
