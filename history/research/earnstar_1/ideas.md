...
| 21 | Windows survival skill | **Shortlist** | Large pain area with no established skill; fully testable on this machine; the demand evidence is medium, because the top-voted Windows issues are app bugs |
