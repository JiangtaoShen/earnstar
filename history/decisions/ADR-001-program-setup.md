...
- **S013, decision #2 (supersedes S008, S009, S012 on promotion)**: on the owner's decision, social promotion is DEV only. HN and Reddit are removed, together with the owner-posting and screenshot-evidence workflow (`tools/evidence.mjs` deleted). Awesome-list PRs (with owner approval) and GitHub's own discovery remain, because they are not social platforms.
