...
| Free-space floor on the work drive | ≥ 30 GB | Keeps the owner's machine usable. Datasets and models go in `lab/` or project folders and are pruned when no longer needed |
