...
- **Hacker News (Show HN)**
  - The owner posts.
  - Title format: `Show HN: <Name> – <what it does>`.
  - The project must be something people can try now.
  - Never solicit votes and never arrange booster comments.
  - HN discourages AI-generated text. The developer therefore supplies talking points and a suggested first comment; the owner rewrites them in their own words, including the AI disclosure.
- **Reddit**
  - The owner posts to 1–2 subreddits whose rules allow it. Check each subreddit's self-promotion rules, AI-content rules, and flair requirements.
  - Tailor the text to each subreddit. No cross-post spam.
- **Awesome lists**
